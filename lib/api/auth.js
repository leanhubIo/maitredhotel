...
module.exports.login = {
    ...
    handler: function (request, reply) {
        ...
        return reply(AuthService.githubHandler(request.auth.credentials, request.server));
    }
};
...
module.exports.logout = {
    ...
    handler: function (request, reply) {
        ...
        return reply(AuthService.removeToken(request.auth.credentials._id, request.server));
    }
};
